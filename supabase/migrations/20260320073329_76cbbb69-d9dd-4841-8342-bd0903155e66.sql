...
BEGIN
  ...
  -- Resolve category display names & slugs matching the search term
  -- e.g. typing "bakery" will match the category slug 'bakery' AND any display_name containing it
  ...
  WHERE sp.verification_status = 'approved'
    ...
    -- Deep match: seller or any product matches
    AND (
      _term IS NULL
