-- Add _scheduled_date and _scheduled_time_start to the 17-arg overload
CREATE OR REPLACE FUNCTION public.create_multi_vendor_orders(
  ...
  _scheduled_date date DEFAULT NULL::date,
  _scheduled_time_start time DEFAULT NULL::time
)
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
...
begin
  ...
  loop
    ...
    values (
      ...
      _scheduled_date, _scheduled_time_start
    )
