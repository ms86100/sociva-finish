...
begin
  ...
  loop
    ...
    -- FIX Bug 2: Check manual_override first, then use day-aware overload
    ...
    -- Also catch 'closed_today' and 'paused' statuses from the day-aware overload
  ...
  -- FIX Bug 1: Use IS NOT DISTINCT FROM to handle NULL society_id
