-- lead_time_hours was integer, truncating fractional hours (e.g. 30 min → 0).
-- Store as numeric hours; supports sub-hour lead times via leadTimeToHours().

ALTER TABLE public.products
  ALTER COLUMN lead_time_hours TYPE numeric(8, 2)
  USING lead_time_hours::numeric;

-- update_product_with_service must cast to numeric, not int
