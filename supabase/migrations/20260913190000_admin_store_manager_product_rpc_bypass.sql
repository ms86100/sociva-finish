-- Admin store manager: allow is_admin() to create/update products via seller RPCs
-- and insert into products (UPDATE/DELETE already allow is_admin).
...
BEGIN
  ...
  INSERT INTO public.products (
    seller_id, name, description, price, mrp, image_url, category, is_veg,
