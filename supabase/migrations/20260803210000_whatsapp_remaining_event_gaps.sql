-- Wire remaining WhatsApp-eligible notification gaps:
-- review nudge (payload column), arrived/in_progress buyer notify,
-- settlement eligible/paid, low-rating seller alert, enriched order payloads.

-- ---------------------------------------------------------------------------
-- 1) Review nudges: notification_queue has payload (not data)
-- ---------------------------------------------------------------------------
