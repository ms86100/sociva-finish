...
begin
  ...
  -- P0 FIX: Online payments → payment_pending (seller NOT notified)
  -- COD → placed (seller notified immediately)
  ...
  loop
    ...
    if not found then
      ...
      -- P0 FIX: Only notify seller when order is placed (COD), NOT payment_pending
