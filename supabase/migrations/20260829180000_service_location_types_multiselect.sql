-- Multi-select service location modes on service_listings (backward compatible with location_type).
...
WHERE location_types IS NULL AND location_type IS NOT NULL;

UPDATE public.service_listings
SET location_types = ARRAY['at_seller']
WHERE location_types IS NULL;
