-- ============================================================
-- Fix: create_multi_vendor_orders referenced non-existent
-- seller_profiles.payment_config. Use fulfillment-specific
-- pickup_payment_config / delivery_payment_config.
-- ============================================================
-- ------------------------------------------------------------
-- 1. Replace create_multi_vendor_orders with payment-config fix
-- ------------------------------------------------------------
