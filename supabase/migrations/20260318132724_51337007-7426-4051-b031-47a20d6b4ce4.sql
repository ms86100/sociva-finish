...
-- Update verify_delivery_otp_and_complete to set app.otp_verified before updating orders
...
BEGIN
  ...
  -- Set the OTP verified marker so the enforce_delivery_otp_gate trigger allows this update
