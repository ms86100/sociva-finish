...
BEGIN
  ...
  IF _fulfillment_type NOT IN ('self_pickup', 'delivery') THEN
    RAISE EXCEPTION 'Invalid fulfillment_type: %', _fulfillment_type;
  END IF;
  ...
  LOOP
    ...
    -- Create order with fulfillment_type and delivery_fee atomically
    INSERT INTO orders (
    ...
    INSERT INTO payment_records (
      ...
      _order_id, _buyer_id, _seller_id, _final_amount + _delivery_fee,
      _payment_method, _payment_status,
      0, _final_amount + _delivery_fee
    );
