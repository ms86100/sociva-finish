...
DROP FUNCTION IF EXISTS public.get_cron_job_runs(bigint, int);
DROP FUNCTION IF EXISTS public.get_cron_job_runs(bigint);

CREATE FUNCTION public.get_cron_jobs()
...
CREATE FUNCTION public.get_cron_job_runs(p_jobid bigint, p_limit int DEFAULT 20)
