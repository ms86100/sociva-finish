...
-- buyer_advance_order: same heal + persist stamp
...
$b$;
  ...
  new_block := $b$
    -- Normalize delivery_handled_by from seller fulfillment_mode (authoritative)
    ...
    -- Fulfillment-aware workflow stamp (map is checkout_mode baseline only)
