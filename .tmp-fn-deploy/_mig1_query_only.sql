...
-- ------------------------------------------------------------
-- 5. P0 ΓÇö harden auto-refund on seller cancel/reject
-- ------------------------------------------------------------
...
BEGIN
  ...
  IF v_refund_amount <= 0 THEN
    -- Fully covered by loyalty/wallet with zero residual ΓÇö still may need wallet reverse
...
-- ------------------------------------------------------------
-- 6. P0 ΓÇö seller_advance_order sets failure_owner on cancel/reject
-- ------------------------------------------------------------
