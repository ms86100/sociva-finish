...
serve(async (req) => {
  ...
  try {
    ...
    // Platform-funded loyalty: commit held reservation after payment confirms
    ...
    return new Response(
      JSON.stringify({ success: allOk, confirmed: successCount, results, loyalty: loyaltyCommit }),
