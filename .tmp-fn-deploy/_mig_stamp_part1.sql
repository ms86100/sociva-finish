...
-- add_to_cart was always stamping cart_purchase, so seller-delivery / pickup
-- orders loaded the platform-delivery state machine. Seller CTA then offered
-- delivery-only ready→picked_up and seller_advance_order rejected it.
