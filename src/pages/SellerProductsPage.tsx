    ...
    <AppLayout showHeader={false}>
      <div className="p-4">
        ...
        {sp.products.length > 0 ? (
          ...
          <div className="text-center py-12 bg-muted rounded-xl px-4">
            {sp.licenseBlocked?.blocked ? (
              <>
